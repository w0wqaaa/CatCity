const LOCATION_GUIDES = {
  ...
  portal_world_3: {
    title: "Долина порталов III",
    subtitle: "Игры для компании.",
    story: [
      "Эта площадка создана для совместных развлечений. Здесь можно сразиться в Морской бой против бота, а остальные измерения ещё дремлют.",
    ],
    goals: [
      "Зайди в «Затонувший флот» — это рабочий Морской бой.",
      "Остальные порталы пока нестабильны.",
      "Зелёный портал вернёт во вторую долину.",
    ],
    controls: [
      "E — войти в измерение",
      "M — миникарта",
