...
const SLIDES = [
  ...
  {
    icon: "🌀",
    title: "Порталы и мини-игры",
    text: "В Долине затерянных порталов стоят несколько порталов. Активные — светятся и реагируют на E. Некоторые ведут в мини-игры.",
    hint: "Инструкция по каждой мини-игре ждёт тебя прямо внутри — просто войди в портал!",
    keys: [
      { key: "E", desc: "Войти в портал" },
    ],
  },
